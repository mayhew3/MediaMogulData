...
public class GamePlatform extends DataObject {
  ...
  public FieldValueString shortName = registerStringField("short_name", Nullability.NOT_NULL);
  public FieldValueString igdbName = registerStringField("igdb_name", Nullability.NOT_NULL);
